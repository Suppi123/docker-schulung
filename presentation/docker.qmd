...
| OCI-Spezifikation | Beschreibt |
|---|---|
| `Image Specification` | Aufbau und Metadaten eines Images |
| `Runtime Specification` | wie ein Container aus einem Image gestartet wird |
| `Distribution Specification` | Austausch über Registries, Push und Pull |
...
- Dadurch koennen verschiedene Tools und Registries zusammenarbeiten.
...
- Fuer Container-Images kommuniziert Docker bei Bedarf mit einer Registry
